<template>
  <button type="button" @click="$emit('open')" v-on-clickaway="emitClickAway" class="robin-button" data-testid="button">
...
export default class OptionButton extends ComponentProps {
  root = null as any
