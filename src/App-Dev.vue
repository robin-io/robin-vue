...
const ComponentProps = mixins(ConversationMixin).extend({
  props: {
    userToken: {
      ...
      default: 'tkaWXfHGnWdSGZTBhKtVhxpl'
    },
    // apiKey: {
    //   type: String as PropType<string>,
    //   default: ''
    ...
    sessionKey: {
      type: String as PropType<string>,
      default: 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzZXNzaW9uIjp7ImV4cGlyZXMiOmZhbHNlLCJleHBpcmVzX2F0IjoiMDAwMS0wMS0wMVQwMDowMDowMFoiLCJ1c2VyX3Rva2VuIjoidGthV1hmSEduV2RTR1pUQmhLdFZoeHBsIn19.DA3XWft794Sl-kayrXCCw2QQ5EbeQgJPX5GR2dxOeB0'
    },
    pageLoader: {
    ...
    userName: {
      type: String as PropType<string>,
      default: 'Favour Testina'
    },
    secretKey: {
      type: String as PropType<string>,
      default: 'NT-ENC-DMYlaPMzcQNWcfmYLGRXdguWagBgLrbfiedN'
    },
    users: {
